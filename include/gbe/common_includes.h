...
// Steamsdk includes
#include "steam_api.h"
// Note: GBE's steam_gameserver.h removed to avoid circular dependency with auth.h
// Note: SDK's steam_gameserver.h also not included here - include directly in files that need it
