...
struct Notification
{
    static constexpr float width_percent = 0.25f;
...
class Steam_Overlay
{
    ...
    bool is_ready = false;
    ENotificationPosition notif_position = k_EPositionBottomLeft;
    int h_inset = 0;
    int v_inset = 0;
    std::string show_url{};
    ...
    static constexpr size_t MAX_NOTIFICATION_HISTORY = 100;
    ...
    ImFont* font_fps{};
    ImFont* font_notif{};
    ImFont* font_ach_title{};
    ImFont* font_ach_desc{};
    ...
    std::chrono::milliseconds last_scheduled_show_time{ 0 };
    ...
    bool submit_notification(notification_type type, const std::string& msg, std::pair<const Friend, friend_window_state>* frd = nullptr, Overlay_Achievement* ach = nullptr);
    ...
    void obscure_game_input(bool state, bool force = false);
...
public:
    bool reload_profile_avatar_resource();
    bool ensure_profile_avatar_loaded();
